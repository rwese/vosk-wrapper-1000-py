...
@pytest.fixture
def mock_managers():
    with patch('main.SignalManager') as mock_sm_cls, \
         patch('main.ModelManager') as mock_mm_cls, \
         patch('main.DeviceManager') as mock_dm_cls, \
         patch('main.HookManager') as mock_hm_cls, \
         patch('main.write_pid'), \
         patch('main.remove_pid'):
        ...
        mock_dm.get_device_info.return_value = (1, {"default_samplerate": 16000, "name": "Mock Device"})
...
def test_service_flow(mock_vosk, mock_sounddevice, mock_managers, capsys):
    ...
    mock_hm.run_hooks.assert_any_call("line", payload="hello world", args=["hello world"])
